        ...
        <>
            ...
            <main style={{padding: "6rem 0"}} className="bg-blue-100">
                ...
                <div className="w-[25%] h-[50vh] border-r-2 overflow-y-scroll">
                    ...
                    {users.map(user => (
                        <button key={user.id} className="py-1 text-center font-bold font-mono border-2 px-10 rounded-lg shrink-0" 
                ...
                <div className="w-7/10 h-[50vh] flex flex-col items-center overflow-y-scroll gap-5">
                    ...
                    <div key={salario.id} className="w-8/10 h-auto border border-blue-300 rounded-lg p-2 font-mono gap-2 flex flex-wrap font-black bg-green-200 shrink-0">
