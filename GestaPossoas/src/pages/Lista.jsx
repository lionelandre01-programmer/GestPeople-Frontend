...
export default function Lista() {
  ...
  return (
    <>
      <Header />
      <Link to="/cadastro" className="flex absolute py-5 px-3 text-center bg-blue-600 border rounded-lg right-25 top-45 text-blue-50 font-bold z-0 text-3xl">
        <FaUserPlus />Add Funcionário
      </Link>
      <main>
              ...
              <tbody>
                {funcionarios.map((func) => (
                  <tr key={func.id} className="border-b hover:bg-gray-100">
                    <td className="px-4 py-2">{func.id}</td>
