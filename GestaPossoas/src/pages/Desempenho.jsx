            ...
            {users.map((user) => (
                ...
                <article key={user.id} className="flex flex-col items-center justify-evenly w-4/10 h-1/2 border rounded-lg p-4">
                    <div className="w-full h-4/10 flex items-center justify-evenly">
                        ...
                        <div className="w-7/10 h-full pl-2 text-blue-700 text-xl font-bold">
                    ...
                    <div className="w-full h-3/10 flex flex-col items-center text-xl justify-center mb-2 font-bold">
                        {user.ult_desempenho ? 
