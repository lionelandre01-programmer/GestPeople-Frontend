            ...
            <div className="flex min-h-40 w-full">
                <aside className="w-3/10 h-full border-r-2 border-gray-300 p-4 flex flex-col gap-3">
                    {messeges.eachUser.map(messege => (
                        ...
                        className="flex items-center justify-center w-full min-h-5 border border-gray-300 rounded-lg cursor-pointer gap-3 p-2">
                            
                            <div className="w-4/10 h-15 rounded-full overflow-hidden border-2 border-gray-500 text-center">
                            ...
                            <div className="w-6/10 h-9/10 text-center overflow-hidden flex flex-col gap-1">
