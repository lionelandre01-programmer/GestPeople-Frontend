...
export default function Back(props){
    ...
    return (
        <div className="w-full h-30 bg-white flex items-center justify-between px-8 border z-10 mb-5">
            <Link to={props.back} className="text-xl"><FaArrowLeft />Voltar</Link>
