export default function Footer() {
  return (
    <footer className="bg-neutral-950 text-neutral-500" id="footer">
      <div className="w-[98vw] mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10" id="foot">
          ...
          {/* Navegação */}
          <div>
            <h3 className="text-3xl font-semibold text-neutral-600 uppercase tracking-wider mb-4">
              Navegação
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xl text-neutral-500">
